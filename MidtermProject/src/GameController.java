...
public class GameController {
	...
	public void initialize() {//initializes GameScene objects. called by JavaFX/Application.
		...
		gameScene[99] = new GameScene("This feature is currently under construction", "Start Game", "Go to Menu", "", 1, 0, 99);
		gameScene[100] = new GameScene("This feature is currently under construction", "Start Game", "Go to Menu", "", 1, 0, 100);
		...
		gameScene[5] = new GameScene("After over an hour of shifting around in a coarse blanket of sand, you hazily drift off into the black."
				...
				"(Start new game?)", "(Load previous save?)", "(Quit?)", 0, 99, 100);
		...
		gameScene[19] = new GameScene("You make it nearly halfway back to where you started from before you collapse due to heat exhaustion, "
				...
				"(Start new game?)", "(Load previous save?)", "(Quit?)", 1, 0, 100);
		
		//some scenes currently under construction:
		gameScene[20] = new GameScene("Scene currently under construction", "Go to menu", "", "", 0, 20, 20);
		gameScene[21] = new GameScene("Scene currently under construction", "Go to menu", "", "", 0, 21, 21);
		gameScene[22] = new GameScene("Scene currently under construction", "Go to menu", "", "", 0, 22, 22);
		gameScene[23] = new GameScene("Scene currently under construction", "Go to menu", "", "", 0, 23, 23);
		gameScene[24] = new GameScene("Scene currently under construction", "Go to menu", "", "", 0, 24, 24);
		gameScene[25] = new GameScene("Scene currently under construction", "Go to menu", "", "", 0, 25, 25);
		gameScene[26] = new GameScene("Scene currently under construction", "Go to menu", "", "", 0, 26, 26);
		gameScene[27] = new GameScene("Scene currently under construction", "Go to menu", "", "", 0, 27, 27);
